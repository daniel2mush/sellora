...
export function CreateAnAccount() {
  return (
    <div
      style={{
        background:
          "linear-gradient(to right, #3E00A0, #9C27B0, #E91E63, #FF8A65, #FFB74D)",
      }}
      ...
      <div className=" z-40 text-white flex flex-col items-center justify-center space-y-5">
        ...
        <p className=" text-balance text-center text-[20px] font-medium ">
          Explore thousands of free vectors, photos, images, and videos created{" "}
          <br /> by amazing artists all over the world!
        </p>
